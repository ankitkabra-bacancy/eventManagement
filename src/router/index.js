    ...
    children: [
      {
        ...
        name: "Home",
        component: () =>
          import(/* webpackChunkName: "home" */ "@/views/Front/Home.vue"),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "AllEvents" */ "@/views/Admin/AllEvents.vue"
          ),
      },
    ],
  },
...
router.beforeEach((to, from, next) => {
  const userRole = store.state.userDetail.user
    ? store.state.userDetail.user.role
    : "";
